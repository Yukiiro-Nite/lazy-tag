...
// copied from here: https://github.com/jellix79/aframe-pipe-component/blob/master/index.js
...
export const Pipe = (pipeAttrs = {}, attributes = {}, children) => h('a-entity',
  {
    ...attributes,
    attrs: {
      ...attributes.attrs,
